...
// Transaction provides a mock function for the type MockOrderDetailRepository
func (_mock *MockOrderDetailRepository) Transaction(context1 context.Context, dB *gorm.DB, fn func(*gorm.DB) error) error {
...
// MockOrderDetailRepository_Transaction_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Transaction'
type MockOrderDetailRepository_Transaction_Call struct {
	*mock.Call
}
...
func (_e *MockOrderDetailRepository_Expecter) Transaction(context1 interface{}, dB interface{}, fn interface{}) *MockOrderDetailRepository_Transaction_Call {
	return &MockOrderDetailRepository_Transaction_Call{Call: _e.mock.On("Transaction", context1, dB, fn)}
}

func (_c *MockOrderDetailRepository_Transaction_Call) Run(run func(context1 context.Context, dB *gorm.DB, fn func(*gorm.DB) error)) *MockOrderDetailRepository_Transaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockOrderDetailRepository_Transaction_Call) Return(err error) *MockOrderDetailRepository_Transaction_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockOrderDetailRepository_Transaction_Call) RunAndReturn(run func(context1 context.Context, dB *gorm.DB, fn func(*gorm.DB) error) error) *MockOrderDetailRepository_Transaction_Call {
	_c.Call.Return(run)
	return _c
}
